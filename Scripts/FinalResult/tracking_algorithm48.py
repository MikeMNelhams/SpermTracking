...
def calc_clusters(data_State, algorithm="kmeans", n_clusters=10, plot=True, plot_type='2d', heatmap=False,
    ...
    valid_algorithms = ["kmeans", "dbscan", "mike", "none", "hdbscan", "gmm", "richard-dbscan", 'mike-htdbscan',
                        "richard-hdbscan", 'mike-hthdbscan', 'ground-truth']
    ...
    colors = [_adjust_lightness(color, 0.5) for color in colors]
...
run_main(algorithm='ground-truth', cover='04', tp='49', plot_type='2d', plot=True, write_output=False)
