...
def calc_clusters(data_State, algorithm="kmeans", n_clusters=10, plot=True, plot_type='2d', heatmap=False,
    ...
    valid_algorithms = ["kmeans", "dbscan", "mike", "none", "hdbscan", "gmm", "htdbscan", "richard-dbscan"]
    ...
    if data_State.frame_num < min_points_for_clustering:
        # Too few data points, then they are all noise
...
# run_main(algorithm=input("'kmeans', 'dbscan', 'mike', 'none', 'hdbscan', 'gmm', 'htdbscan', 'richard-dbscan' ? "))
...
# run_main(algorithm='richard-dbscan', cover='04', plot=True, plot_type='2d')
